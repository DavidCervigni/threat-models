...
Context: threat modeling and its terminilogy
    ...
    Context: Exmple yaml Files
        File: /Users/david.cervigni/workspace/personal/threat-models/threatModels/Kubernetes/Secrets/Secrets.yaml
        ```yaml
        ID: Secrets
        title: Secrets 
        version: 1.0
          ...
          - ID: EXCESSIVE_SECRET_ACCESS
            ...
            countermeasures:
              - ID: LEAST_PRIVILEGE_ACCESS
                ...
                public: true
        ```
        File: /Users/david.cervigni/workspace/personal/threat-models/threatModels/Kubernetes/Kubernetes.yaml
        ```yaml
        ID: Kubernetes
        title: Kubernetes
        version: 1.0
          ...
          - ID: SUPPLY_CHAIN_COMPROMISE
            ...
            countermeasures:
              - ID: IMAGE_SCANNING
                ...
                public: true
        ```
        File: /Users/david.cervigni/workspace/personal/threat-models/threatModels/IntelSGX/IntelSGX.yaml
        ```yaml
        ID: IntelSGX
        title: Intel SGX
        authors: |
          ...
          - ID: ATTESTATION_SPOOFING
            ...
            countermeasures:
              - ID: REMOTE_ATTESTATION_VALIDATION
                ...
                public: true
        ```
        File: /Users/david.cervigni/workspace/personal/threat-models/threatModels/ARM_TrustedPlatform/Trusted_Firmware/Trusted_Firmware.yaml
        ```yaml
        ID: Trusted_Firmware
        ...
        threats:
          ...
          - ID: BOOTLOADER_ATTACK
            ...
            fullyMitigated: false
        ```
        File: /Users/david.cervigni/workspace/personal/threat-models/threatModels/ARM_TrustedPlatform/ARM_TrustedPlatform.yaml
        ```yaml
          ...
          - ID: SECURE_BOOT_SPOOFING
            ...
            countermeasures:
              - ID: ROOT_OF_TRUST
                ...
                public: true
        ```
        File: /Users/david.cervigni/workspace/personal/threat-models/threatModels/Bitcoin/ARK/ARK.yaml
        ```yaml
        ID: ARK
        title: ARK L2
        version: 1.1
        ...
        threats:
          ...
          - ID: DOS_ATTACK
            ...
            fullyMitigated: false
        ```
        File: /Users/david.cervigni/workspace/personal/threat-models/threatModels/Bitcoin/LightningNetwork/LightningNetwork.yaml
        ```yaml
        ID: LightningNetwork
        parent: Bitcoin
          ...
          - ID: WATCHTOWER_FAILURE
            ...
            countermeasures:
              - ID: DISTRIBUTED_WATCHTOWERS
                ...
                public: true
        ```
        File: /Users/david.cervigni/workspace/personal/threat-models/threatModels/Bitcoin/Mixing/Mixing.yaml
        ```yaml
        ID: Mixing
          ...
          - ID: NETWORK_LEVEL_ANALYSIS
            ...
            countermeasures:
              - ID: TOR_VPN_USAGE
                ...
                public: true
        ```
        File: /Users/david.cervigni/workspace/personal/threat-models/threatModels/Bitcoin/Bitcoin.yaml
        ```yaml
        ID: Bitcoin
        title: Bitcoin
        version: 1.0
        ...
        threats:
          ...
          #       public: true  
        ```
        File: /Users/david.cervigni/workspace/personal/threat-models/threatModels/LLM_adoption/LLM_adoption.yaml
        ```yaml
        ...
        threats:
          ...
          - ID: LLM16_FEATURE_DATA_EXPOSURE
            ...
            fullyMitigated: false
        ```
        File: /Users/david.cervigni/workspace/personal/threat-models/threatModels/OAuth2/Flows/Flows_ImplicitGrant/Flows_ImplicitGrant.yaml
        ```yaml
        ...
        ```
        File: /Users/david.cervigni/workspace/personal/threat-models/threatModels/OAuth2/Flows/Flows_AuthCode/Flows_AuthCode.yaml
        ```yaml
        #based on: https://datatracker.ietf.org/doc/html/rfc6819
          ...
          - ID: 4_4_1_13_CODE_SUBSTITUTION
            ...
            countermeasures:
              ...
              - ID: SECURE_USER_LOGIN_PROTOCOL
                ...
                public: true
        ```
        File: /Users/david.cervigni/workspace/personal/threat-models/threatModels/OAuth2/Flows/Flows.yaml
        ```yaml
        #based on: https://datatracker.ietf.org/doc/html/rfc6819
        ...
        threats:
          ...
          #       public: true       
        ```
        File: /Users/david.cervigni/workspace/personal/threat-models/threatModels/OAuth2/Client/Client.yaml
        ```yaml
        #based on: https://datatracker.ietf.org/doc/html/rfc6819
          ...
          - ID: TOO_MUCH_GRANT
            ...
            countermeasures:
              ...
              - ID: USER_AUTH_AWARENESS
                ...
                public: true
        ```
        File: /Users/david.cervigni/workspace/personal/threat-models/threatModels/OAuth2/AuthorizationServer/AuthorizationServer.yaml
        ```yaml
        #based on: https://datatracker.ietf.org/doc/html/rfc6819
          ...
          - ID: 4_3_5_CLIENT_SECRET_BRUTE_FORCE
            ...
            countermeasures:
              ...
              - ID: 5_2_3_7_STRONG_CLIENT_AUTHENTICATION
                ...
                public: true
        ```
        File: /Users/david.cervigni/workspace/personal/threat-models/threatModels/OAuth2/OAuth2.yaml
        ```yaml
        #based on: https://datatracker.ietf.org/doc/html/rfc6819
